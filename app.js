...
$(document).ready(function () {
    'use strict';
    var openweath = "https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?lat=51.46&lon=-2.6&appid=cd5d1b218b56cc19fd423497c76cdc4b";
    $.getJSON(openweath, function (weath) {
        var icon = "https://cors-anywhere.herokuapp.com/https://openweathermap.org/img/w/" + weath.weather[0].icon + ".png";
